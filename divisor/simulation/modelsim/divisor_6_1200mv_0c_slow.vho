...
-- Equation(s):
-- \count~5_combout\ = (\Add0~12_combout\ & !\Equal0~7_combout\)
...
-- Equation(s):
-- \count~4_combout\ = (\Add0~22_combout\ & !\Equal0~7_combout\)
...
-- Equation(s):
-- \count~3_combout\ = (\Add0~24_combout\ & !\Equal0~7_combout\)
...
-- Equation(s):
-- \count~2_combout\ = (\Add0~26_combout\ & !\Equal0~7_combout\)
...
-- Equation(s):
-- \count~1_combout\ = (\Add0~28_combout\ & !\Equal0~7_combout\)
...
-- Equation(s):
-- \count~0_combout\ = (\Add0~32_combout\ & !\Equal0~7_combout\)
...
-- Equation(s):
-- \Equal0~5_combout\ = (count(18) & (count(19) & (!count(17) & count(0))))
...
-- Equation(s):
-- \Equal0~2_combout\ = (!count(7) & (!count(8) & (!count(6) & count(5))))
...
-- Equation(s):
-- \Equal0~0_combout\ = (count(13) & (count(14) & (count(16) & !count(15))))
...
-- Equation(s):
-- \Equal0~1_combout\ = (!count(9) & (!count(10) & (count(11) & count(12))))
...
-- Equation(s):
-- \Equal0~3_combout\ = (count(3) & (count(2) & (count(1) & count(4))))
...
-- Equation(s):
-- \Equal0~7_combout\ = (\Equal0~6_combout\ & (count(24) & (\Equal0~5_combout\ & \Equal0~4_combout\)))
...
-- Equation(s):
-- \temp~0_combout\ = \temp~q\ $ (\Equal0~7_combout\)
